    ...
    <div class="conteiner">
      ...
      <form action="insertCadastroLogin.php" method="post" class="col-6 offset-3">
        ...
        <div class="control-group form-group">
          <div class="controls">
            <label for="Inome">Nome Fantasia </label>
        ...
        <div class="control-group form-group">
          <div class="controls">
            <label for="Iemail">CNPJ</label>
            <input type="email" class="form-control" name="txtCnpj" id="Iemail" required data-validation-required-message="Por favor, digite seu email.">
          </div>
        </div>
        <div class="control-group form-group">
          <div class="controls">
            <label for="Itel">Seguimento</label>
            <input type="tel" class="form-control" name="txtSeguimento" id="Itel" required data-validation-required-message="Por favor, digite seu telefone.">
          </div>
        </div>
