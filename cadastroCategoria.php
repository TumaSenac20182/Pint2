    ...
    <div class="conteiner">
      ...
      <form action="insertCadastroLogin.php" method="post" class="col-6 offset-3">
        ...
        <div class="control-group form-group">
          <div class="controls">
            <label for="Inome">Categoria</label>
            <input type="text" class="form-control" name="txtCategoria" id="Inome" required data-validation-required-message="Por favor, digite seu nome.">
          </div>
        </div>
