      ...
      <form action="insertCadastroLogin.php" method="post" class="col-6 offset-3">
        ...
        <div class="control-group form-group">
          <div class="controls">
            ...
            <input type="text" class="form-control" name="txtNome" id="Inome" required data-validation-required-message="Por favor, digite seu nome.">
          </div>
        </div>
        <div class="control-group form-group">
          <div class="controls">
            <label for="Iemail">Email</label>
            <input type="email" class="form-control" name="txtEmail" id="Iemail" required data-validation-required-message="Por favor, digite seu email.">
          </div>
        </div>
        <div class="control-group form-group">
          <div class="controls">
            <label for="Itel">Telefone</label>
            <input type="tel" class="form-control" name="txtTelefone" id="Itel" required data-validation-required-message="Por favor, digite seu telefone.">
          </div>
        </div>
        <div class="control-group form-group">
          <div class="controls">
            <label for="Icpf">senha</label>
            <input type="password" class="form-control" name="txtSenha" id="Isenha" required data-validation-required-message="Por favor, digite seu CPF.">
          </div>
        </div>
