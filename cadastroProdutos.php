  ...
  <body>
    ...
    <div class="conteiner">
      ...
      <form action="insertCadastroLogin.php" method="post" class="col-6 offset-3">
        ...
        <div class="control-group form-group">
          <div class="controls">
            <label for="Iemail">Preço</label>
            <input type="email" class="form-control" name="txtPreço" id="Iemail" required data-validation-required-message="Por favor, digite seu email.">
          </div>
        </div>
        <div class="control-group form-group">
          <div class="controls">
            <label for="Itel">Descrição</label>
            <input type="tel" class="form-control" name="txtDescricao" id="Itel" required data-validation-required-message="Por favor, digite seu telefone.">
          </div>
        </div>
