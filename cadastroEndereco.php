    ...
    <div class="conteiner">
      ...
      <form action="insertCadastro.php" method="post" class="col-6 offset-3">
        ...
        <div class="control-group form-group">
          <div class="controls">
            <label for="Inome">logradouro</label>
            <input type="text" class="form-control" name="txtLogradouro" id="Inome" required data-validation-required-message="Por favor, digite seu nome.">
          </div>
        </div>
        <div class="control-group form-group">
          <div class="controls">
              <label for="Irua">Bairro</label>
            <input type="text" class="form-control" name="txtBairro" id="Irua" required data-validation-required-message="Por favor, digite sua rua.">
          </div>
        </div>
        <div class="control-group form-group">
          <div class="controls">
            <label for="InumeroCasa">Número</label>
            <input type="text" class="form-control" name="txtNumero" id="InumeroCasa" required data-validation-required-message="Por favor, digite o número da sua residência.">
          </div>
        </div>
        <div class="control-group form-group">
          <div class="controls">
            <label for="Ibairro">Cidade</label>
            <input type="text" class="form-control" name="txtCidade" id="Ibairro" required data-validation-required-message="Por favor, digite seu bairro.">
          </div>
        </div>
        <div class="control-group form-group">
          <div class="controls">
            <label for="Icidade">uf</label>
            <input type="text" class="form-control" name="txtUf" id="Icidade" required data-validation-required-message="Por favor, digite sua cidade.">
          </div>
        </div>
        <div class="control-group form-group">
          <div class="controls">
            <label for="Icidade">Referencia</label>
            <input type="text" class="form-control" name="txtReferencia" id="Icidade" required data-validation-required-message="Por favor, digite sua cidade.">
          </div>
        </div>
